...
SimpleColorDrawer *SimpleColorDrawer::instance = NULL;

SimpleColorDrawer::SimpleColorDrawer() {
    init_colorVtxs();
}
...
void SimpleColorDrawer::init_colorVtxs() {
    if(!this->colorVtxs) {
...
void SimpleColorDrawer::draw_internal(float x,float y, float width, float height) {
